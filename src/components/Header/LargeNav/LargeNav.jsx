      ...
      <div className="w-full h-full flex flex-col relative">
        ...
        <div className="w-full h-auto flex items-start flex-col gap-y-2">
          ...
          >
            ...
            />
            <p className="text-[16px] font-semibold text-white lg:block md:hidden sm:hidden hidden">
              Home
            </p>
          </Link>
          {sidebarItems.map((item) => (
            ...
            >
              <img
                ...
                className="w-7 h-7 object-contain group-hover:scale-105 ease-out duration-300"
              />
              <p className="text-[16px] font- font-normal text-white lg:block md:hidden sm:hidden hidden">
                {item.name}
              </p>
            </Link>
          ))}
          ...
          >
            ...
            />
            <p className="text-[16px] font-normal text-white lg:block md:hidden sm:hidden hidden">
              Profile
            </p>
          </Link>
        </div>
        <div className="w-full h-auto absolute bottom-0 left-0 px-o">
          ...
          >
            <img
              ...
              className="w-7 h-7 object-contain group-hover:scale-105 ease-out duration-300"
            />
            <p className="text-[17px] font-medium text-white lg:block md:hidden sm:hidden hidden">
              More
            </p>
          </Link>
        </div>
